...
C2R_model = cobra.io.read_sbml_model(ruta_C2R)

#Crear un modelo COMETS
test_model = c.model(C2R_model)
...
test_tube.set_specific_metabolite("h2o_e H2O", 100)
...
test_tube.set_specific_metabolite("ala__L_e", 10)
test_tube.set_specific_metabolite("lys__L_e", 100)
test_tube.set_specific_metabolite("asp__L_e", 100)
...
test_model.change_bounds('EX_glc__D_e', -1000, 1000)

# set the model's initial biomass
test_model.initial_pop = [0, 0, 5e-6]
