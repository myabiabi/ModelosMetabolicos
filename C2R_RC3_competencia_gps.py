...
C2R_gps = c.model(cobra.io.read_sbml_model(ruta_C2R))
C2R_gps.id = 'c2r'
RC3_gps = c.model(cobra.io.read_sbml_model(ruta_RC3))
RC3_gps.id = 'rc3'

# set its initial biomass, 5e-6 gr at coordinate [0,0]
C2R_gps.initial_pop = [0, 0, 5e-8]
RC3_gps.initial_pop = [0, 0, 5e-8]

# create an empty layout
test_tube = c.layout()

# add the models to the test tube
test_tube.add_model(C2R_gps)
test_tube.add_model(RC3_gps)
...
output_folder = 'graficas/competition_assay/C2R_RC3'
output_path = os.path.join(output_folder, '0708_C2R_RC3_competencia_gps_1.png')
plt.savefig(output_path)
...
output_folder = 'graficas/competition_assay/C2R_RC3'
output_path = os.path.join(output_folder, '0708_C2R_RC3_competencia_LB_gps_1.png')
plt.savefig(output_path)
