...
gem = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/01_data/models_gapseq/gem_clust_LB/ST00143.xml')
met_model = c.model(gem)

# set its initial biomass, 5e-6 gr at coordinate [0,0]
met_model.initial_pop = [0, 0, 1e-8]

# create an empty layout
test_tube = c.layout()

# add the models to the test tube
test_tube.add_model(met_model)
