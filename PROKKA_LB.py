...
bac_model = c.model(cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/01_data/models_carveme/prokka/lb/ST00143.xml'))
bac_model.id = 'paenibacillus'


# set its initial biomass, 5e-6 gr at coordinate [0,0]
bac_model.initial_pop = [0, 0, 5e-8]

# create an empty layout
test_tube = c.layout()

# add the models to the test tube
test_tube.add_model(bac_model)
...
output_path = os.path.join(output_folder, 'ST00143_.png')
