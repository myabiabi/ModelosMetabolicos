...
RC3_gps = c.model(cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/GEM_1/gps_RC3.xml'))
RC3_gps.id = 'rc3'
...
output_path = os.path.join(output_folder, '0708_RC3_gps_1.png')
...
output_folder = 'graficas/competition_assay/C2R_RC3'
output_path = os.path.join(output_folder, '0708_RC3_LB_gps_1.png')
plt.savefig(output_path)
