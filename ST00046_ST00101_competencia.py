...
output_folder = 'graficas/competition_assay/C2R_RC3'
output_path = os.path.join(output_folder, '0710_ST00046_ST00101_competencia.png')
plt.savefig(output_path)
...
comp_params.set_param('timeStep', 240)
#calcular la aptitud competitiva del mutante con respecto al tipo salvaje como el cociente entre el aumento de 
#biomasa del mutante y el del tipo salvaje:
total_time_hours = comp_params.get_param('maxCycles',240) * comp_params.get_param('timeStep')
total_time_days = total_time_hours / 24
print(total_time_days)
...
C2R = c.model(cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/GEM_1/CarveMe/cvm_ST00046.xml'))
C2R.id = 'c2r'
RC3 = c.model(cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/GEM_1/CarveMe/cvm_ST00101.xml'))
RC3.id = 'rc3'
...
output_folder = 'graficas/competition_assay/ST00046_ST00101'
output_path = os.path.join(output_folder, '0721_ST00046_ST00101_competencia_2.png')
plt.savefig(output_path)
...
C2R.id = 'ST0046'
RC3 = c.model(cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/GEM_1/Gapseq/gps_ST00101.xml'))
RC3.id = 'ST00101'
...
comp_params = c.params()
comp_params.set_param('maxCycles', 240)
comp_params.set_param('timeStep', 0.01)
...
output_path = os.path.join(output_folder, '0722_ST00046_ST00101_competencia.png')
plt.savefig(output_path)

comp_params = c.params()
for key, value in comp_params.all_params.items():
  print(f"{key}: {value}")
...
C2R = c.model(cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/GEM/gs_ST00046.xml'))
C2R.id = 'ST0046'
RC3 = c.model(cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/GEM/gs_ST00101.xml'))
RC3.id = 'ST00101'
...
output_folder = 'graficas/competition_assay/ST00046_ST00101'
output_path = os.path.join(output_folder, '0721_ST00046_ST00101_competencia_GPS_5.png')
plt.savefig(output_path)
