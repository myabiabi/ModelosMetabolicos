...
ST60 = c.model(cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/carveme_models/ST00060.xml'))
ST60.id = 'ST00060'
...
trace_metabolites = ['ca2_e', 'cl_e', 'cobalt2_e', 'cu2_e', 'fe2_e', 'fe3_e', 'h_e', 'k_e', 'h2o_e', 'mg2_e',
                     'mn2_e', 'na1_e', 'o2_e', 'pi_e', 'so4_e', 'zn2_e']
...
ax = experiment.total_biomass.plot(x = 'cycle', color = 'black')
...
#090325
#Modelo modificando los parametros de dimont
...
ST00060_diamon = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/ST00060_diamon.xml')
ST00060 = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/carveme_models/DEFAULT/carve60.xml')

print(len(ST00060_diamon.exchanges))
print(len(ST00060.exchanges))


ST60 = c.model(cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/carveme_models/DEFAULT/carve60.xml'))
...
output_path = os.path.join(output_folder, 'ST00060_dimont.png')
plt.savefig(output_path)
