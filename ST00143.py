...
ST143 = c.model(cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/carveme_models/ST00143.xml'))
ST143.id = 'ST00143'
...
trace_metabolites = ['ca2_e', 'cl_e', 'cobalt2_e', 'cu2_e', 'fe3_e', 'h_e', 'k_e', 'h2o_e', 'mg2_e',
                     'mn2_e', 'na1_e', 'o2_e', 'so4_e', 'zn2_e']
...
ax = experiment.total_biomass.plot(x = 'cycle', color = 'blue')
ax.set_ylabel("Biomass (gr.)")

output_folder = 'graficas_/CARVEME'
output_path = os.path.join(output_folder, 'ST00143_3.png')
...
ST00143_diamon = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/ST00143_diamon.xml')
ST00143 = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/carveme_models/DEFAULT/carve143.xml')

print(len(ST00143_diamon.exchanges))
print(len(ST00143.exchanges))


ST143 = c.model(cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/ST00143_diamon.xml'))
...
output_path = os.path.join(output_folder, 'ST00143_dimont.png')
plt.savefig(output_path)
...
ST00143_d = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/ST00143_diamon.xml')
ST00143_egg = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/carveme_models/eggnote/ST143_egg.xml')
ST00143_d2 = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/carveme_models/DIMONT_2/ST00143_d2.xml')

len(ST00143_d.exchanges)
len(ST00143_egg.exchanges)
len(ST00143_d2.exchanges)
...
#ST00143 = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/01_data/models_carveme/DEFAULT/carve143.xml')
...
output_path = os.path.join(output_folder, 'ST00143.png')
plt.savefig(output_path)
...
#ST00143 = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/01_data/models_carveme/DEFAULT/carve143.xml')
#ST00143 = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/01_data/models_carveme/DIAMONT/ST00143_diamon.xml')
ST00143 = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/01_data/models_gapseq/gem_clust/ST00143.xml')
ST143 = c.model(ST00143)
ST143.id = "Paenibacillus"
