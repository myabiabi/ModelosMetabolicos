...
#090325
ST00154 = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/carveme_models/carve154.xml')
ST154_dimon = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/ST00154_diamon.xml')

print(len(ST00154.exchanges))
print(len(ST154_dimon.exchanges))


ST154 = c.model(cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/ST00154_diamon.xml'))
...
output_path = os.path.join(output_folder, 'ST000154_diamont.png')
plt.savefig(output_path)
...
#ST00154 = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/01_data/models_carveme/DEFAULT/carve154.xml')
#ST00154 = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/01_data/models_carveme/DIAMONT/ST00154_diamon.xml')
ST00154 = cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/01_data/models_carveme/DIAMONT_2/ST00154dd.xml')
ST154 = c.model(ST00154)
...
output_path = os.path.join(output_folder, 'ST00154.png')
plt.savefig(output_path)
