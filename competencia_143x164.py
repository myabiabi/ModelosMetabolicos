...
output_folder = '03_graficas/CARVEME/competencia'
output_path = os.path.join(output_folder, 'competencia_143x164.png')
...
ST143_d = c.model(cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/01_data/models_carveme/DIAMONT_2/ST00143dd.xml'))
ST164_d = c.model(cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/01_data/models_carveme/DIAMONT_2/ST00164dd.xml'))
ST143_d.id ='Paenibacillus'
ST164_d.id ='Bacillus'

# set its initial biomass, 5e-6 gr at coordinate [0,0]
ST143_d.initial_pop = [0, 0, 5e-8]
...
ax = comp_assay.total_biomass.plot(x = 'cycle', color = ['purple', 'green'])
ax.set_ylabel("Biomass (gr.)")

output_folder = 'graficas/CARVEME/DIMONT'
output_path = os.path.join(output_folder, '143x164.png')
plt.savefig(output_path)