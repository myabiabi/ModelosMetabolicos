...
ST42_d.id = 'Pseudomonas_umsongensis'
ST164_d.id = 'Bacillus_thuringiensis'
...
ax = comp_assay.total_biomass.plot(x = 'cycle', color = ['orange', 'blue'])
ax.set_ylabel("Biomass (gr.)")

output_folder = 'graficas/CARVEME/DIMONT'
output_path = os.path.join(output_folder, '42x164.png')
...
ax = comp_assay.total_biomass.plot(x = 'cycle', color = ['purple', 'green', 'yellow'])
ax.set_ylabel("Biomass (gr.)")

output_folder = 'graficas/CARVEME'
output_path = os.path.join(output_folder, '42x164x143.png')
plt.savefig(output_path)
