...
bac = c.model(cobra.io.read_sbml_model('/home/abigaylmontantearenas/Documents/practicas/MODELOS/data/carveme_models/DIMONT_2/ST00042dd.xml'))
bac.id = 'Arthrobacter'
# set its initial biomass, 5e-6 gr at coordinate [0,0]
bac.initial_pop = [0, 0, 5e-8]

# create an empty layout
test_tube = c.layout()

# add the models to the test tube
test_tube.add_model(bac)
...
output_path = os.path.join(output_folder, '42_.png')
