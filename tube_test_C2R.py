...
test_tube.set_specific_metabolite("lys_L_e", 10)
test_tube.set_specific_metabolite("asp_L_e", 10)
...
output_path = os.path.join(output_folder, '063025_TTEST_C2R_nutrientes.png')
